...
public class Combobox<E> extends JComboBox<E> {
    ...
    private void installUI() {
        ...
        setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> jlist, Object o, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    com.setBackground(combinedColor);
                    com.setForeground(new Color(255, 255, 255));
                    com.setFont(new Font(com.getFont().getName(), Font.BOLD, 13));
                }
                return com;
            }
        });
    ...
    public Combobox() {
        ...
        setBorder(new EmptyBorder(20, 0, 1, 0));
        setForeground(color1);
        setFont(new Font(getFont().getName(), Font.BOLD, 13));
        installUI();
    }
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private void createHintText(Graphics2D g2) {
            ...
            Font labelFont = new Font(g2.getFont().getName(), Font.BOLD, 14);
