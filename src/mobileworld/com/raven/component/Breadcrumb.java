...
import mobileWorld.com.raven.shadow.ShadowRenderer;
...
import mobileWorld.com.raven.component.BreadcrumbItem;
import mobileWorld.com.raven.component.Item;
...
public class Breadcrumb extends JPanel {
    ...
    public Breadcrumb() {
        initComponents();
        setOpaque(false);
        home1.setEvent(new EventItemSelected() {
            @Override
    ...
    private void initComponents() {
        ...
        home1 = new mobileworld.com.raven.component.Home();
    ...
    private mobileworld.com.raven.component.Home home1;
