...
public class ViewKhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnLamMoi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mobileworld/icon/icons8-clear-30.png"))); // NOI18N
        ...
        tblBang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Khách Hàng", "Tên", "SĐT", "Giới Tính", "Ngày Sinh", "Địa Chỉ"
            }
        ));
...
// Check if selected date is before current date
        ...
        if (selectedDate.before(currentDate)) {
            JOptionPane.showMessageDialog(this, "Ngày sinh không được nhỏ hơn ngày hiện tại");
            return;
        }
